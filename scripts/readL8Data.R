...
IMAGE_DIR = paste(getwd(), "/L8_cropped", sep="") # please change
...
raster_cube(col, v, L8.clear_mask) %>%
  ...
  write_tif(paste(getwd(), "/L8cube2", sep=""),prefix = "NDVI_")
...
IMAGE_DIR = IMAGE_DIR = paste(getwd(), "/L8_cropped", sep="") # please change
